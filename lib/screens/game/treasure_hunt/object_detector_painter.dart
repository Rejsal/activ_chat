...
import 'package:activ_chat/utils/cordinate_translator.dart';
...
class ObjectDetectorPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final Paint background = Paint()..color = const Color(0x99ffffff);
    ...
    for (final DetectedObject detectedObject in _objects) {
      ...
      builder.pushStyle(ui.TextStyle(color: kPrimary, background: background));
